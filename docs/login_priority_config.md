...
- 服务端当前对华为 `1.0.6`、`1.0.7`、`1.0.8` 内置提审态：`android_feature_flags.phone_login_entry_enabled=false`。iOS `1.0.7`、`1.0.8` 提审态同样关闭 `ios_feature_flags.phone_login_entry_enabled`。
